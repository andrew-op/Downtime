...
def show_how_to_play():
    ...
    print()
    print("IMPORTANT:")
    print("  • To complete the game, you MUST document your solution using the")
    print("    desktop computer in the IT Office")
    print("  • Use 'computer' command in IT Office to access the ticket system")
    print()
    print("─"*70)
    print()
...
def show_about():
    ...
    print()
    print("  CREDITS:")
    print("  QA Testing: Lauren & Jeff")
    print("  Thank you for your invaluable feedback and testing!")
    print()
    print("─"*70)
    print()
    print("              Press any key to return to menu...")
